...
# -*- coding: utf-8 -*-
#
# Hermes-3 documentation build configuration file, created by
...
if has_breathe:
    ...
    breathe_projects = { "hermes3": "../doxygen/hermes3/xml" }
    breathe_default_project = "hermes3"
...
author = 'The BOUT++ team and Hermes-3 authors'
...
latex_documents = [
    (master_doc, 'hermes3.tex', 'Hermes-3 Documentation',
...
man_pages = [
    (master_doc, 'hermes3', 'Hermes-3 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hermes3', 'Hermes-3 Documentation',
     author, 'Hermes-3', 'One line description of project.',
     'Miscellaneous'),
]
