...
private:
  ...
  struct RecycleChannel {
    ...
    BoutReal target_multiplier, sol_multiplier, pfr_multiplier, pump_multiplier, penalty_multiplier;
    BoutReal target_energy, sol_energy, pfr_energy, penalty_energy; ///< Energy of recycled particle (normalised to Tnorm)
    BoutReal target_fast_recycle_fraction, pfr_fast_recycle_fraction, sol_fast_recycle_fraction, penalty_fast_recycle_fraction;   ///< Fraction of ions undergoing fast reflection
    BoutReal target_fast_recycle_energy_factor, sol_fast_recycle_energy_factor, pfr_fast_recycle_energy_factor, penalty_fast_recycle_energy_factor;   ///< Fraction of energy retained by fast recycled neutrals
    ...
    Field3D penalty_density_source, penalty_energy_source;  ///< Recycling sources for penalty recycling
  };

  std::vector<RecycleChannel> channels; // Recycling channels

  bool target_recycle, sol_recycle, pfr_recycle, penalty_recycle, neutral_pump;  ///< Flags for enabling recycling in different regions
