  ...
  if (diagnose) {
    ...
    set_with_attrs(state[std::string("DnnNn_") + name], DnnNn,
                   {{"time_dimension", "t"},
                    ...
                    {"long_name", ""},
                    {"source", "neutral_mixed"}});
    set_with_attrs(state[std::string("kappa_n_") + name], kappa_n,
                   {{"time_dimension", "t"},
                    {"units", "m^2/s"},
                    {"conversion", Cs0 * Cs0 / Omega_ci * Nnorm},
                    {"standard_name", ""},
                    {"long_name", ""},
                    {"source", "neutral_mixed"}});
    set_with_attrs(state[std::string("kappa_n_max_") + name], kappa_n_max,
                   {{"time_dimension", "t"},
                    {"units", "m^2/s"},
                    {"conversion", Cs0 * Cs0 / Omega_ci * Nnorm},
                    {"standard_name", ""},
                    {"long_name", ""},
                    {"source", "neutral_mixed"}});
    set_with_attrs(state[std::string("kappa_n_unlimited_") + name], kappa_n_unlimited,
                   {{"time_dimension", "t"},
                    {"units", "m^2/s"},
                    {"conversion", Cs0 * Cs0 / Omega_ci * Nnorm},
                    {"standard_name", ""},
                    {"long_name", ""},
                    {"source", "neutral_mixed"}});
    set_with_attrs(state[std::string("kappa_n_Dnchained_") + name], kappa_n_Dnchained,
                   {{"time_dimension", "t"},
                    {"units", "m^2/s"},
                    {"conversion", Cs0 * Cs0 / Omega_ci * Nnorm},
                    {"standard_name", ""},
