...
g11 = 1.1 + 0.16*x*cos(y) #*sin(z)
g22 = 0.9 + 0.09*x*cos(y) #*sin(z)
g33 = 1.2 + 0.2*x*cos(y) #*sin(z)
g12 = 0.2 + 0.11*x*cos(y) #*sin(z)
g23 = 0.5 + 0.15*x*cos(y) #*sin(z)
g13 = 0.3 + 0.13*x*cos(y) #*sin(z)
